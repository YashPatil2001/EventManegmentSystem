...
import com.example.eventManagementSystem.CustomerAPI.CustomerUploadData;
import com.example.eventManagementSystem.CustomerAPI.CustomerViewMessage;
...
public class SignUpCustomer extends Activity implements CustomerViewMessage {
    ...
    private void checkID(){
        FirebaseFirestore.getInstance().collection("StudentData")
                ...
                }).addOnFailureListener(e -> Toast.makeText(SignUpCustomer.this, e.getMessage().toString(), Toast.LENGTH_LONG).show());
    }
